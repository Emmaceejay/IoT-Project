...
esp_err_t DSGV_device_config_load(void) {
    ...
    strlcpy(g_device_config.device_type, DSGV_DEVICE_TYPE,
            sizeof(g_device_config.device_type));
    strlcpy(g_device_config.capabilities, DSGV_DEVICE_CAPABILITIES,
            sizeof(g_device_config.capabilities));
    g_device_config.relay_count = DSGV_RELAY_COUNT;
