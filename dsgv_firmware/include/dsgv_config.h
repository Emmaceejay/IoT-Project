...
/**
 * DSGV_config.h
 * Central configuration for all DSGV Hub firmware builds.
...
// DSGV_DEVICE_TYPE is used as a prefix in the auto-generated device name.
...
#define DSGV_DEVICE_TYPE        "Switch"   // Switch | Dimmer | Sensor | Thermostat | RGB
#define dsgv_firmware_VERSION   "1.0.0"
...
//
// Multi-gang relay config (edit DSGV_RELAY_COUNT + DSGV_RELAY_PINS together):
...
#  define DSGV_RELAY_COUNT        1
#  define DSGV_RELAY_PINS         { GPIO_NUM_4 }
...
#  define DSGV_RELAY_COUNT        1
#  define DSGV_RELAY_PINS         { GPIO_NUM_26 }
...
//   e.g. "DSGVHub_A1B2C3"
// QR on device label: dsgv://provision?name=DSGVHub_A1B2C3
//
