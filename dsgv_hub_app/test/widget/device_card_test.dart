...
class _StubRepository implements DeviceRepository {
  ...
  @override
  Future<List<IoTDevice>> getDevices() async => devices;
  @override
...
Widget _wrap(Widget child, {List<IoTDevice> devices = const []}) {
