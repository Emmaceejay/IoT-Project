...
void main() {
  group('SmartDevice', () {
    ...
    test('default status is offline', () {
      const d = SmartDevice(uniqueDeviceId: 'X', deviceName: 'X');
    ...
    test('fromJson parses all fields correctly', () {
      ...
      final device = SmartDevice.fromJson(json);
    ...
    test('fromJson parses provisioning status', () {
      ...
      expect(SmartDevice.fromJson(json).status, DeviceStatus.provisioning);
    });
    ...
    test('toJson → fromJson round-trip preserves identity', () {
      final restored = SmartDevice.fromJson(baseDevice.toJson());
