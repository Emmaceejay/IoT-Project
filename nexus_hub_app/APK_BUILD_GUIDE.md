...
```
nexus_hub_app\build\app\outputs\flutter-apk\
```
...
All commands above must be run from inside the `nexus_hub_app` folder:

```bash
cd "c:\Users\ojike\OneDrive\Documents\AI_projects\IoT-Project\nexus_hub_app"
flutter build apk --release
```
